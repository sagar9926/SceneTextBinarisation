...
The Street View Text (SVT) dataset was harvested from Google Street View. Image text in this data exhibits high variability and often has low resolution. [SVT Dataset link](https://www.kaggle.com/datasets/nageshsingh/the-street-view-text-dataset)
